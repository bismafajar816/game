...
namespace Task02
{
    ...
    { ' ', k, ' ' , ' ' }};
      ...
      static  bool game = true;
            ...
            while (opt < 3)
            {
                ...
                if(opt == 1)
                {
                    ...
                    while (game)
                    {
                        ...
                        MotionOfHero(Maze, hero, HeroLeft, ref HeroX, ref HeroY, ref Direction, HerobulletX, HerobulletY, HerobulletDirection, ref HerobulletCount, ref check, ref game, ref score, ref Enemyhealth, ref Herohealth);
        ...
        static void moveheroDown(char[,] Maze, char[,] hero, char[,] HeroLeft, ref int HeroX, ref int HeroY, ref string Direction, ref int score)
        {
            char next = Maze[HeroY + 3, HeroX];
            char next1 = Maze[HeroY + 3, HeroX + 1];
            char next2 = Maze[HeroY + 3, HeroX + 2];
            char next3 = Maze[HeroY + 3, HeroX + 3];
        ...
        static void MotionOfHero(char[,] Maze, char[,] hero, char[,] HeroLeft, ref int HeroX, ref int HeroY, ref string Direction, int[] HerobulletX, int[] HerobulletY, char[] HerobulletDirection, ref int HerobulletCount, ref int check, ref bool game, ref int score, ref int Enemyhealth, ref int Herohealth)
        {
            ...
            {
                moveheroDown(Maze, hero, HeroLeft, ref HeroX, ref HeroY, ref Direction, ref score);
            }
            if (Keyboard.IsKeyPressed(Key.Space))
            {
                createBullet(Maze, ref HeroX, ref HeroY, ref Direction, HerobulletX, HerobulletY, HerobulletDirection, ref HerobulletCount);
            }
        }
       
        static void printHero(char[,] hero, ref int HeroX, ref int HeroY)
        {
        ...
        static void eraseHero(ref int HeroX, ref int HeroY)
        {
            Console.ForegroundColor = ConsoleColor.Cyan;
            int x = HeroX;
            int y = HeroY;
        ...
        static void printHeroLeft(char[,] heroLeft, ref int HeroX, ref int HeroY)
        {
        ...
        static void createBullet(char[,] Maze, ref int HeroX, ref int HeroY, ref string Direction, int[] HerobulletX, int[] HerobulletY, char[] HerobulletDirection, ref int HerobulletCount)
        {
            if (Direction == "right")
            {
                Console.Beep();
                char next = Maze[HeroY + 1, HeroX + 4];
                if (next == ' ')
                {
                    HerobulletX[HerobulletCount] = HeroX + 4;
                    HerobulletY[HerobulletCount] = HeroY + 1;
            ...
            if (Direction == "left")
            {
                ...
                char next = Maze[HeroY + 1, HeroX - 1];
                if (next == ' ')
                {
                    HerobulletX[HerobulletCount] = HeroX - 1;
                    HerobulletY[HerobulletCount] = HeroY + 1;
                    HerobulletDirection[HerobulletCount] = 'L';
                    Console.SetCursorPosition(HeroX - 1, HeroY + 1);
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("*");
                    HerobulletCount++;
                    Console.ForegroundColor = ConsoleColor.Red;
